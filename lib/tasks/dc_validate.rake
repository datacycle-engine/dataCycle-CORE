...
namespace :dc do
  ...
  namespace :templates do
    ...
    task validate: :environment do
      ...
      errors, mixin_errors = DataCycleCore::MasterData::ImportTemplates.validate_all

      if mixin_errors.present?
      ...
      errors.blank? && mixin_errors.blank? ? puts('[done] ... looks good') : exit(-1)
    end
  end
end
