...
class AddColumnsToSearches < ActiveRecord::Migration[6.1]
  def up
    execute <<-SQL.squish
      ...
      SET dict = REPLACE(pg_dict_mappings.dict::varchar, 'pg_catalog.', '')
      WHERE pg_dict_mappings.dict::varchar ilike 'pg_catalog.%';

      INSERT INTO pg_dict_mappings (locale, dict) VALUES ('ar', 'simple'), ('bg', 'simple'), ('cs', 'simple'), ('hr', 'simple'), ('ja', 'simple'), ('ko', 'simple'), ('pl', 'simple'), ('ro', 'simple'), ('sl', 'simple'), ('sk', 'simple'), ('uk', 'simple'), ('nl-BE', 'dutch'), ('zh', 'simple') ON CONFLICT (locale, dict) DO UPDATE SET dict = EXCLUDED.dict;
