  ...
  def up
    execute <<~SQL.squish
      ...
      CREATE TRIGGER update_classification_alias_paths_trigger
        AFTER UPDATE ON classification_aliases
        FOR EACH ROW
      ...
      CREATE TRIGGER update_classification_alias_paths_trigger
        AFTER UPDATE ON classification_trees
        FOR EACH ROW
      ...
      CREATE TRIGGER update_classification_alias_paths_trigger
        AFTER UPDATE ON classification_tree_labels
        FOR EACH ROW
      ...
      CREATE TRIGGER update_collected_classification_content_relations_trigger_1
        AFTER UPDATE ON classification_contents
        FOR EACH ROW
