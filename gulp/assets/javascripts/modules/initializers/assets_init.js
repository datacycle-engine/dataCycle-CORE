...
module.exports.initialize = function() {
  ...
  let validate_dimensions = function(validations, the_file, media_params) {
    if (media_params !== undefined) {
      var additional = reject(validations, ["landscape", "portrait", "exclude"]);
      if (object_helpers.get(["exclude", "format"], validations) !== null && object_helpers.get(["exclude", "format"], validations).indexOf(the_file.type.split("/").pop()) !== -1) {
        return {
          valid: true,
          message: undefined
        };
      ...
      for (var key in additional) {
        if (
          ...
          ((additional[key].max.height !== undefined && media_params.height <= additional[key].max.height) ||
            (additional[key].max.width !== undefined && media_params.width <= additional[key].max.width))
        ) {
          return {
            valid: true,
            message: undefined
        ...
        if (
          ...
          ((additional[key].min.height !== undefined && media_params.height >= additional[key].min.height) ||
            (additional[key].min.width !== undefined && media_params.width >= additional[key].min.width))
        ) {
          return {
            valid: true,
            message: undefined
      ...
      if (
        ...
        var message =
          ...
          (object_helpers.get(["landscape", "min"], validations) !== null
            ? " für Querformat mind. " + object_helpers.get(["landscape", "min", "width"], validations) + "x" + object_helpers.get(["landscape", "min", "height"], validations)
            : "") +
          ...
          (object_helpers.get(["portrait", "min"], validations) !== null
            ? " für Hochformat mind. " + object_helpers.get(["portrait", "min", "width"], validations) + "x" + object_helpers.get(["portrait", "min", "height"], validations)
            : "") +
          " sein.";
        return {
          valid: false,
      ...
      if (
        ...
        var message =
          ...
          (object_helpers.get(["landscape", "max"], validations) !== null
            ? " für Querformat max. " + object_helpers.get(["landscape", "max", "width"], validations) + "x" + object_helpers.get(["landscape", "max", "height"], validations)
            : "") +
          ...
          (object_helpers.get(["portrait", "max"], validations) !== null
            ? " für Hochformat max. " + object_helpers.get(["portrait", "max", "width"], validations) + "x" + object_helpers.get(["portrait", "max", "height"], validations)
            : "") +
          " sein.";
        return {
          valid: false,
      ...
      if (event.target.files != undefined && event.target.files.length > 0) {
        ...
        for (var i = 0; i < new_files.length; i++) {
          ...
          reader.onload = (function(the_file) {
            return function(e) {
              var media_html = '<dl class="file-info"><dt>Format:</dt><dd>' + the_file.type.split("/").pop() + "</dd>, <dt>Größe:</dt><dd>" + the_file.size.file_size(1) + "</dd>";
