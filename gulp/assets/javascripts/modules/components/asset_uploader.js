    ...
    reader.onload = (function(the_file) {
      return function(e) {
        ...
        for (const key in that.validations) {
          if (that.validations[key].format.indexOf(file_extension) !== -1) type_validations.push(that.validations[key]);
        }
...
AssetUploader.prototype.VideoValidator = function(file_options) {
  var that = this;
  file_options.prepend_html += '<span class="file-thumb"><i class="fa fa-video-camera" aria-hidden="true"></i></span>';
...
AssetUploader.prototype.AudioValidator = function(file_options) {
  file_options.prepend_html += '<span class="file-thumb"><i class="fa fa-file-audio-o" aria-hidden="true"></i></span>';
  file_options.media_html += '</dl>';
  this.validateAndRender(file_options);
};

AssetUploader.prototype.PdfValidator = function(file_options) {
  file_options.prepend_html += '<span class="file-thumb"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span>';
  file_options.media_html += '</dl>';
  this.validateAndRender(file_options);
};

AssetUploader.prototype.TextFileValidator = function(file_options) {
...
AssetUploader.prototype.validate_file_size = function(file_options, validations) {
  var messages = '';
  var valid = true;
...
AssetUploader.prototype.validate_dimensions = function(file_options, validations) {
