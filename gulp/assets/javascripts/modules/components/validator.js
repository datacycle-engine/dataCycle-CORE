...
let Validator = function(form_element) {
...
Validator.prototype.closeError = function(event) {
...
Validator.prototype.validateAgbs = function(validation_container) {
  let error = {
    error: {},
    warning: {}
  };
...
Validator.prototype.removeSubmitButtonErrors = function(item) {
  var item_id = '';
  let item_label = $(item)
    .find('label')
    .first();
...
Validator.prototype.resetField = function(validation_container) {
  $(validation_container)
...
Validator.prototype.findItemsForField = function(validation_container) {
  let items = [];
...
Validator.prototype.validateItem = function(validation_container) {
