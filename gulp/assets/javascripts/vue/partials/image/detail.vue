<template>
  <div v-if="item.id != undefined">
    ...
    <dl v-if="item.metadata != undefined">
      <dt class="block-flex" v-if="item.metadata.thumbnail_url != undefined"></dt>
      <dd class="block-flex" v-if="item.metadata.thumbnail_url != undefined">
        <img :src=" item.metadata.thumbnail_url ">
      </dd>
      ...
      <dd class="block-flex" v-if="item.metadata.restrictions != undefined && item.metadata.restrictions != '' && item.metadata.restrictions != 'Keine Einschränkung;'"><i v-if="item.metadata.restrictions != undefined && item.metadata.restrictions != null && item.metadata.restrictions.indexOf('gesperrt') !== -1" class="fa fa-exclamation-triangle" aria-hidden="true"></i> {{ item.metadata.restrictions }}</dd>
      ...
      <dt v-if="item.metadata.validity_period != undefined">Gültigkeit: </dt>
      <dd v-if="item.metadata.validity_period != undefined">
