      ...
      class UserInfoActivity < Base
        def apply(params)
          raw_query = <<-SQL.squish
            ...
            SELECT u.id, u.given_name as first_name,  u.family_name as last_name, u.email, u.created_at, u.updated_at, u.last_sign_in_at, u.current_sign_in_at, u.sign_in_count, u.deleted_at, u.locked_at, u.external, u.ui_locale , roles.name AS role_name, ua.activity_type AS latest_activity_type, lat.latest_api_access
            FROM users u
