    ...
    module Eyebase
      module Transformations
        ...
        def self.eyebase_to_bild(external_source_id)
          ...
          .>> t(:unwrap, 'quality_1', ['resolution_x', 'resolution_y', 'size_mb', 'filename_ext'])
          ...
          .>> t(:extension_to_mimetype, 'file_format', ->(s) { s.dig('filename_ext', 'text')&.delete_prefix('.') }, 'image')
          .>> t(:reject_keys, ['item_id', 'titel', 'field_202', 'field_224', 'copyright', 'field_216', 'resolution_x', 'resolution_y', 'size_mb', 'filename_ext'])
        ...
        def self.to_video(external_source_id)
          ...
          .>> t(:extension_to_mimetype, 'file_format', ->(s) { unwrap_video_data(s, 'filename_ext')&.delete('.') }, 'video')
          .>> t(:add_field, 'external_key', ->(s) { s.dig('item_id', 'text') })
          .>> t(:add_field, 'description', ->(s) { s.dig('beschreibung', '#cdata-section') })
          .>> t(:add_field, 'name', ->(s) { s.dig('titel', '#cdata-section') })
          .>> t(:add_field, 'attribution_name', ->(*) {})
        ...
        def self.to_audio(external_source_id)
          ...
          .>> t(:extension_to_mimetype, 'file_format', ->(s) { unwrap_media_data(s, 'filename_ext')&.delete('.') }, 'audio')
          .>> t(:add_field, 'external_key', ->(s) { s.dig('item_id', 'text') })
          .>> t(:add_field, 'description', ->(s) { s.dig('beschreibung', '#cdata-section') })
          .>> t(:add_field, 'name', ->(s) { s.dig('titel', '#cdata-section') })
          .>> t(:add_field, 'attribution_name', ->(*) {})
