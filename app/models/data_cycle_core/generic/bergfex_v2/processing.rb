      ...
      module Processing
        def self.process_lake(utility_object, raw_data, config)
          DataCycleCore::Generic::Common::ImportFunctions.process_step(
            ...
            raw_data: raw_data,
            transformation: DataCycleCore::Generic::BergfexV2::Transformations.bergfex_to_see,
        ...
        def self.process_ski_resort(utility_object, raw_data, config, locale)
          ...
          DataCycleCore::Generic::Common::ImportFunctions.process_step(
            utility_object: utility_object,
            raw_data: raw_data,
            transformation: DataCycleCore::Generic::BergfexV2::Transformations.bergfex_to_ski_resort(utility_object.external_source.id),
        ...
        def self.transform_snow_report(utility_object, raw_data, config, locale)
          DataCycleCore::Generic::Common::ImportFunctions.merge_default_values(
            config,
            DataCycleCore::Generic::BergfexV2::Transformations
