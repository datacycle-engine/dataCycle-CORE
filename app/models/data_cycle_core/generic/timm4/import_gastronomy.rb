      ...
      module ImportGastronomy
        ...
        def self.process_content(utility_object:, raw_data:, locale:, options:)
          I18n.with_locale(locale) do
            [raw_data['image'], raw_data['headerImage'], *raw_data['images']].compact.each do |image_data|
              data =
            ...
            DataCycleCore::Generic::Timm4::Processing.process_gastronomy(
              utility_object,
              raw_data,
              options.dig(:import, :transformations, :gastronomy)
            )
          end
        end
      end
