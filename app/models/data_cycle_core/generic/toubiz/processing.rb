      ...
      module Processing
        def self.process_poi(utility_object, raw_data, config)
          DataCycleCore::Generic::Common::ImportFunctions.process_step(
            ...
            raw_data: raw_data,
            transformation: DataCycleCore::Generic::Toubiz::Transformations.to_poi(utility_object.external_source.id),
        ...
        def self.process_tour(utility_object, raw_data, config)
          DataCycleCore::Generic::Common::ImportFunctions.process_step(
            utility_object: utility_object,
            raw_data: raw_data,
            transformation: DataCycleCore::Generic::Toubiz::Transformations.to_tour(utility_object.external_source.id),
        ...
        def self.process_image(utility_object, raw_data, config)
          DataCycleCore::Generic::Common::ImportFunctions.process_step(
            utility_object: utility_object,
            raw_data: raw_data,
            transformation: DataCycleCore::Generic::Toubiz::Transformations.to_image,
