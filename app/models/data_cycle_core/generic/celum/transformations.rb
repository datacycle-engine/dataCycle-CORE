    ...
    module Celum
      module Transformations
        ...
        def self.document_to_media_object(external_source_id)
          ...
          .>> t(:add_links, 'asset_collections_celum', DataCycleCore::Classification, external_source_id, ->(s) { ["AssetCollection:#{s&.dig('assetCollections', 'assetCollection', '#cdata-section')}"] }, ->(s) { s&.dig('assetCollections', 'assetCollection', '#cdata-section') })
