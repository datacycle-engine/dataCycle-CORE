...
module DataCycleCore
  module Generic
    module Celum
      module ImportKeywordCatalogs
        def self.import_data(utility_object:, options:)
          DataCycleCore::Generic::Common::ImportFunctions.import_classifications(
            utility_object,
            options.dig(:import, :tree_label) || 'Celum - KeywordCatalogs',
        ...
        def self.load_root_classifications(mongo_item, _locale, _options)
          mongo_item.where('dump.de.parent.#cdata-section': '1')
        end
        ...
        def self.load_parent_classification_alias(raw_data, external_source_id, _options = {})
          DataCycleCore::Classification
            .find_by(
              ...
              external_key: "KeywordCatalog:#{raw_data.dig('parent', '#cdata-section')}"
            )
        ...
        def self.extract_data(_options, raw_data)
          {
            external_key: "KeywordCatalog:#{raw_data.dig('id', '#cdata-section')}",
