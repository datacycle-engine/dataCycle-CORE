  ...
  module Generic
    class ImportBase < Base
      ...
      def merge_default_values(item, data_hash)
        new_hash = {}
        new_hash = DataCycleCore::Generic::Common::Functions.load_default_values(@options.dig(:import, :default_values, item)) if @options.dig(:import, :default_values, item).present?
