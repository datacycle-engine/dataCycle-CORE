    ...
    module Common
      class Webhook < DataCycleCore::Generic::WebhookBase
        ...
        def download_content(download_config:, data_name:, data:)
          ...
          download_object = DataCycleCore::Generic::DownloadObject.new(full_options.merge(external_source:, locales:))
        ...
        def import_content(import_config:, data_name:, data:, locale:)
          ...
          import_object = DataCycleCore::Generic::ImportObject.new(full_options.merge(external_source:, locales:))
