            ...
            data.merge(
              {
                'aggregate_rating' => rating_configs.select { |rating_config|
                  ...
                  {
                    'id' => (DataCycleCore::Generic::Common::DataReferenceTransformations::ExternalReference.new(:content, external_source_id, external_key) if external_source_id && external_key),
