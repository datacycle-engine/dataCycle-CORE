    ...
    module Common
      module ImportFunctions
        ...
        def self.create_or_update_content(utility_object:, template:, data:, local: false, config: {})
          ...
          error = content.set_data_hash(data_hash: normalized_data, prevent_history: !utility_object.history, update_search_all: false, current_user: current_user, partial_update: utility_object.partial_update, new_content: created)
