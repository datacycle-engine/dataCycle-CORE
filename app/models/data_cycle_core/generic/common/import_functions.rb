                ...
                begin
                  ...
                  utility_object.source_object.with(utility_object.source_type) do |mongo_item|
                    filter_object = Import::FilterObject.new(options&.dig(:import, :source_filter), locale, mongo_item, binding)
                      .without_deleted
                      .without_archived
                    filter_object = filter_object.with_updated_since(utility_object.external_source.last_try_successful) if utility_object.mode == :incremental && utility_object.external_source.last_try_successful.present?
