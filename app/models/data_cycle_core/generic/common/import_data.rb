                ...
                begin
                  ...
                  utility_object.source_object.with(utility_object.source_type) do |mongo_item|
                    filter_object = Import::FilterObject.new(nil, locale, mongo_item, binding)
                      .with_deleted
                    filter_object = filter_object.with_deleted_since(utility_object.external_source.last_try_successful) if utility_object.mode == :incremental && utility_object.external_source.last_try_successful.present?
