    ...
    module ReisenFuerAlle
      module Transformations
        ...
        def self.to_rating(external_source_id)
          ...
          .>> t(:unwrap, 'public_pdf')
          .>> t(:add_field, 'short_report', ->(s) { s.dig('url_for_short_report', I18n.locale.to_s) })
          .>> t(:add_field, 'allergic', ->(s) { s.dig('url_for_allergic', I18n.locale.to_s) })
          .>> t(:add_field, 'deaf', ->(s) { s.dig('url_for_deaf', I18n.locale.to_s) })
          .>> t(:add_field, 'generations', ->(s) { s.dig('url_for_generations', I18n.locale.to_s) })
          .>> t(:add_field, 'mental', ->(s) { s.dig('url_for_mental', I18n.locale.to_s) })
          .>> t(:add_field, 'visual', ->(s) { s.dig('url_for_visual', I18n.locale.to_s) })
          .>> t(:add_field, 'walking', ->(s) { s.dig('url_for_walking', I18n.locale.to_s) })
          .>> t(:add_field, 'wheelchair', ->(s) { s.dig('url_for_wheelchair', I18n.locale.to_s) })
          .>> t(:nest, 'public_pdf', ['short_report', 'allergic', 'deaf', 'generations', 'mental', 'visual', 'walking', 'wheelchair'])
