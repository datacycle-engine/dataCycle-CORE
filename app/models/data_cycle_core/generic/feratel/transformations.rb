    ...
    module Feratel
      module Transformations
        ...
        def self.feratel_to_accommodation(external_source_id)
          ...
          .>> t(:add_field, 'meta_rating_code', ->(s) { s&.dig('MetaRating', 'RatingSystem') == 'TrustYou' ? s&.dig('MetaRating', 'PartnerRatingCode') : s&.dig('MetaRating', 'RatingCode') })
          .>> t(:add_external_system_data, ['MetaRating', 'RatingSystem'], 'meta_rating_code')
          .>> t(:reject_keys, ['meta_rating_code'])
