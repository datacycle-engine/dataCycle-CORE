  ...
  module MasterData
    class NormalizeData
      ...
      def normalize(data, template_hash)
        ...
        normalize_hash, transformation_hash = preprocess_data(template_hash, data)

        report = @endpoint.normalize(reduce_data(normalize_hash))

        postprocess_data(data, report, transformation_hash)
      end
