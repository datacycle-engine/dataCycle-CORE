    ...
    module Differs
      class Schedule < UuidSet
        ...
        def diff_schedule(a, b)
          a_hash = (a.is_a?(DataCycleCore::Schedule) || a.is_a?(IceCube::Schedule) ? a.to_h : a)&.except('relation', 'thing_id')
          b_hash = (b.is_a?(DataCycleCore::Schedule) || b.is_a?(IceCube::Schedule) ? b.to_h : b)&.except('relation', 'thing_id')
