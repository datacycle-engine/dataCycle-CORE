  ...
  module MasterData
    module DataConverter
      ...
      def self.string_to_geographic(value)
        ...
        begin
          return RGeo::Geographic.spherical_factory(srid: 4326, wkt_parser: { support_wkt12: true }).parse_wkt(value)
        rescue RGeo::Error::ParseError => e
          e
        end
        begin
          return RGeo::Geographic.spherical_factory(srid: 4326, has_z_coordinate: true, wkt_parser: { support_wkt12: true }).parse_wkt(value)
        rescue RGeo::Error::ParseError => e
          e
        end
        raise e
