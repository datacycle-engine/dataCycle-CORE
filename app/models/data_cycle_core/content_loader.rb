...
module DataCycleCore
  module ContentLoader
    ...
    def delete_classification_content(content_id, content_type, relation_name, ids)
      DataCycleCore::ClassificationContent
        .for_content(content_id, content_type)
        .for_relation(relation_name)
        .for_classification_ids(ids)
        .destroy_all
    end

    def insert_classification_content(content_id, content_type, relation_name, ids)
      DataCycleCore::ClassificationContent
        .find_or_create_by(
          'content_data_id' => content_id,
          'content_data_type' => content_type,
