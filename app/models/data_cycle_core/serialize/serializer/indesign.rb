                  ...
                  data:
                    Nokogiri::XML(
                      DataCycleCore::Xml::V1::WatchListsController.renderer.new(
                        ...
                        assigns: { watch_list: watch_list, language: language, include_parameters: ['linked'], mode_parameters: ['indesign'], api_version: 1, api_context: 'xml' },
                  ...
                  data:
                    Nokogiri::XML(
                      DataCycleCore::Xml::V1::ContentsController.renderer.new(
                        ...
                        assigns: { contents: pagination_contents, language: language, include_parameters: ['linked'], mode_parameters: ['indesign'], api_version: 1, api_context: 'xml' },
              ...
              data:
                Nokogiri::XML(
                  DataCycleCore::Xml::V1::ContentsController.renderer.new(
                    ...
                    assigns: { content: content, language: language, include_parameters: ['linked'], mode_parameters: ['indesign'], api_version: 1, api_context: 'xml' },
