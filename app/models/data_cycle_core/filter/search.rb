...
module DataCycleCore
  module Filter
    class Search < QueryBuilder
      ...
      def not_with_content_ids(ids = nil)
        return self if ids.blank?
        reflect(
      ...
      def not_with_filter_ids(ids = nil)
        return self if ids.blank?
        filter_query_sql_ids = []
        ids.each do |filter|
          stored_filter = DataCycleCore::StoredFilter.find(filter)
      ...
      def with_watch_list_ids(ids = nil)
        return self if ids.blank?
      ...
      def not_with_watch_list_ids(ids = nil)
        return self if ids.blank?
