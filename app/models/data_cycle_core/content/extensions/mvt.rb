    ...
    module Extensions
      module Mvt
        ...
        def to_mvt(x, y, z, simplify_factor: nil, include_parameters: [], fields_parameters: [], classification_trees_parameters: [])
          DataCycleCore::Geo::MvtRenderer.new(x, y, z, contents: self.class.where(id:).limit(1), simplify_factor:, include_parameters:, fields_parameters:, classification_trees_parameters:, single_item: true).render
        end
        ...
        class_methods do
          def to_mvt(x, y, z, layer_name: nil, simplify_factor: nil, include_parameters: [], fields_parameters: [], classification_trees_parameters: [], single_item: false)
            DataCycleCore::Geo::MvtRenderer.new(x, y, z, layer_name:, contents: all, simplify_factor:, include_parameters:, fields_parameters:, classification_trees_parameters:, single_item:).render
          end
