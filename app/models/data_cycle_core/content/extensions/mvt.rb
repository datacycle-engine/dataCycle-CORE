  ...
  module Content
    module Extensions
      module Mvt
        ...
        class_methods do
          def to_mvt(x, y, z, layer_name: nil, simplify_factor: nil, include_parameters: [], fields_parameters: [], classification_trees_parameters: [], single_item: false, cache: true, cluster: false, cluster_lines: false, cluster_layer_name: nil)
            DataCycleCore::Geo::MvtRenderer.new(
              x,
              y,
              z,
