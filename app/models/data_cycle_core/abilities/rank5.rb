  ...
  module Abilities
    class Rank5 < DataCycleCore::Ability
      ...
      def initialize(user, _session = {})
        ...
        can [:create, :update, :destroy], [DataCycleCore::Image, DataCycleCore::Video, DataCycleCore::TextFile, DataCycleCore::Audio, DataCycleCore::Pdf, DataCycleCore::DataCycleFile], creator_id: user&.id
