...
module DataCycleCore
  class StoredFilter < ApplicationRecord
    ...
    belongs_to :linked_stored_filter, class_name: 'DataCycleCore::StoredFilter', foreign_key: :linked_stored_filter_id, inverse_of: :filter_uses
    has_many :filter_uses, class_name: 'DataCycleCore::StoredFilter', foreign_key: :linked_stored_filter_id, dependent: :nullify, inverse_of: :linked_stored_filter
