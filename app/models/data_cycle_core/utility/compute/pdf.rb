      ...
      module Pdf
        class << self
          ...
          def thumbnail_url(**args)
            args.dig(:data_hash, args.dig(:key)) || args.dig(:content).try(args.dig(:key)) || DataCycleCore::Pdf.find_by(id: args.dig(:computed_parameters)&.first)&.file&.thumb_preview&.url
          end
