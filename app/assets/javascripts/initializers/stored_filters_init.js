...
export default function () {
  DataCycle.initNewElements('.stored-searches-list:not(.dcjs-stored-filter)', e => new StoredFilter(e));
  DataCycle.initNewElements(
    '.update-stored-search-form[data-update-params="true"]:not(.dcjs-stored-filter-form)',
