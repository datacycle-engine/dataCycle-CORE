...
export default function () {
  function init() {
    DataCycle.initNewElements('.dropdown-pane.watch-lists:not(.dcjs-collection-filter)', e => new CollectionFilter(e));
    DataCycle.initNewElements('.add-items-to-watch-list-form:not(.dcjs-collection-form)', e => new CollectionForm(e));
