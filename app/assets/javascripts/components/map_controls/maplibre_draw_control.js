class MaplibreDrawControl {
  ...
  addButton(opt) {
    ...
    button.className = `mapbox-gl-draw_ctrl-draw-btn maplibregl-draw_ctrl-draw-btn dc-map-control-button ${opt.key} ${opt.class}`;
