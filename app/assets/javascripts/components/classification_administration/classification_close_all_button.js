class ClassificationCloseAllButton {
  ...
  closeAllChildren(event) {
    ...
    this.closeDirectChildren(this.item.closest('li').querySelector(':scope > span.inner-item > a.name'));
  }
  closeDirectChildren(element) {
    ...
    for (const child of element
      .closest('li')
      .querySelectorAll(':scope > ul.children .name.dcjs-classification-name-button'))
