...
module DataCycleCore
  class ClassificationService
    ...
    def self.update_transitive_trigger_status
      ...
      DataCycleCore::RunTaskJob.perform_later("db:configure:#{DataCycleCore.transitive_classification_paths ? 'db:configure:rebuild_cap_transitive' : 'db:configure:rebuild_ca_paths'}")
