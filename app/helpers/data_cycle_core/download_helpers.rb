...
module DataCycleCore
  module DownloadHelpers
    ...
    def available_locales_for_select(content)
      available_languages = content.try(:translated_locales)&.present? ? available_locales_with_names.slice(*content.translated_locales) : available_locales_with_names.except(:all)
