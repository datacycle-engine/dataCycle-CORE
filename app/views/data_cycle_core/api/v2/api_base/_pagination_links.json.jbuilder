...
json.links do
  ...
  json.next object_url.call(page: { number: objects.next_page, size: objects.limit_value }) if objects.next_page && !objects.last_page?
  json.last object_url.call(page: { number: objects.total_pages, size: objects.limit_value }) unless objects.last_page?
end
