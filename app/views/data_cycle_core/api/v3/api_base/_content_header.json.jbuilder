...
unless options[:header_type] == :overlay
  ...
  json.set! '@id', send("api_v#{@api_version}_#{content.class.class_name.tableize.singularize}_url", content, @language != I18n.available_locales.first.to_s ? { language: @language } : {})
