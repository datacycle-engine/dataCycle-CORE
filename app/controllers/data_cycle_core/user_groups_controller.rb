...
module DataCycleCore
  class UserGroupsController < ApplicationController
    ...
    def create
      ...
      if @user_group.save
        flash[:success] = I18n.t :created, scope: [:controllers, :success], data: 'Benutzergruppe', locale: helpers.active_ui_locale
      else
    ...
    def update
      if @user_group.update(user_group_params)
        flash[:success] = I18n.t :updated, scope: [:controllers, :success], data: 'Benutzergruppe', locale: helpers.active_ui_locale
    ...
    def destroy
      if @user_group.destroy
        flash[:success] = I18n.t :destroyed, scope: [:controllers, :success], data: 'Benutzergruppe', locale: helpers.active_ui_locale
      else
        flash[:error] = @user_group.try(:errors).try(:first).try(:[], 1)
      end
      redirect_back(fallback_location: root_path)
