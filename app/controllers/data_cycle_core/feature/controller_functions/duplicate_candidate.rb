    ...
    module ControllerFunctions
      module DuplicateCandidate
        ...
        def merge_and_remove_duplicate
          ...
          redirect_back_or_to(root_path, alert: (I18n.t 'controllers.error.duplicate.type_mismatch', locale: helpers.active_ui_locale)) && return if @content.template_name != @duplicate.template_name
