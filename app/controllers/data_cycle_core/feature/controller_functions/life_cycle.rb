      ...
      module LifeCycle
        ...
        def update_life_cycle
          ...
          if DataCycleCore::Feature::IdeaCollection.enabled? &&
            ...
            idea_collection = DataCycleCore::DataHashService.create_internal_object(controller_name, DataCycleCore::Feature::IdeaCollection.template_name, idea_collection_params, current_user)
