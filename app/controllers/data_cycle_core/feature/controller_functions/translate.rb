      ...
      module Translate
        ...
        included do
          DataCycleCore::Engine.routes.prepend do
            get '/things/translate_text', action: :translate_text, controller: 'things', as: 'translate_text_thing' unless has_named_route?(:translate_text_thing)
          end
        ...
        def translate_text
          ...
          render plain: [translated_text.presence&.x, translated_text.presence&.y].compact.to_json, content_type: 'application/json'
        end
