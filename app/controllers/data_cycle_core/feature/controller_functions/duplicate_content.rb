    ...
    module ControllerFunctions
      module DuplicateContent
        def create_duplication
          ...
          redirect_back(fallback_location: root_path, alert: I18n.t(:content_duplication_invalid, scope: [:controllers, :error], locale: DataCycleCore.ui_language)) && return unless new_content
