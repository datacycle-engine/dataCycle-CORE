    ...
    module ControllerFunctions
      module Normalize
        ...
        def normalize
          ...
          render(plain: { error: I18n.t('validation.warnings.no_data', data: 'Normalisierung', locale: helpers.active_ui_locale) }.to_json, content_type: 'application/json') && return if external_source.blank? || @content.blank?
