    ...
    module V4
      class ContentsController < ::DataCycleCore::Api::V4::ApiBaseController
        ...
        def index
          ...
          ActiveRecord::Base.transaction(joinable: false, requires_new: true) do
            ...
            Timeout.timeout(puma_max_timeout, DataCycleCore::Error::Api::TimeOutError, "Timeout Error for API Request: #{@_request.fullpath}") do
              ...
              render(plain: query.query.to_geojson(include_parameters: @include_parameters), content_type: request.format.to_s) && next if request.format.geojson?
        ...
        def show
          ...
          render(plain: @content.to_geojson(include_parameters: @include_parameters), content_type: request.format.to_s) && return if request.format.geojson?
        end
