    ...
    module V4
      class UniversalController < ::DataCycleCore::Api::V4::ApiBaseController
        ...
        def show
          ...
          elsif DataCycleCore::Thing.where("id::VARCHAR ILIKE '#{permitted_params[:id][0..-14]}%'").present? # for generated uuids in e.g. DZT exported Things
            id = DataCycleCore::Thing.find_by("id::VARCHAR ILIKE '#{permitted_params[:id][0..-14]}%'").id
