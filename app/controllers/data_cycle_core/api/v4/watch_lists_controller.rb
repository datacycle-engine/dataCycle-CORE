  ...
  module Api
    module V4
      class WatchListsController < ::DataCycleCore::Api::V4::ContentsController
        ...
        def create
          @watch_list = current_user.watch_lists.create(full_path: "Download #{I18n.l(Time.zone.now, locale: helpers.active_ui_locale)}", thing_ids: Array(permitted_params[:thing_id]))
