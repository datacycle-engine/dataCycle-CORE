module DataCycleCore
  class DataLinksController < ApplicationController
    ...
    def show
      ...
      raise ActiveRecord::RecordNotFound.new('Link nicht mehr gültig!') unless !link.nil? && link.is_valid?
    ...
    def create
      redirect_back(fallback_location: root_path, alert: (I18n.t :invalid_mail, scope: [:controllers, :success], locale: DataCycleCore.ui_language)) unless receiver_params[:email] =~ Devise.email_regexp
