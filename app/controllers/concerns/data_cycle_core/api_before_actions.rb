...
module DataCycleCore
  module ApiBeforeActions
    ...
    def set_api_version
      ...
      @api_subversion = api_version_params[:api_subversion] if DataCycleCore.main_config.dig(:api, "v#{@api_version}".to_sym, :subversions)&.include?(api_version_params[:api_subversion])
    end
