...
module DataCycleCore
  ...
  module RemoteRenderGuard
    ...
    ALLOWED_PARTIALS = [
      ...
      'data_cycle_core/classifications/concept_form',
      'data_cycle_core/classifications/concept_polygon_map',
      'data_cycle_core/classifications/concept_removal_warning',
      'data_cycle_core/classifications/concept_scheme_form',
      'data_cycle_core/classifications/concept_scheme_link_reveal',
      'data_cycle_core/classifications/concept_scheme_link_warning',
      'data_cycle_core/classifications/concept_scheme_removal_warning',
