...
- [Datenschnittstelle](/docs/api)
    ...
    - [Datenschnittstelle für Inhalte (Ad-Hoc-Datenendpunkte)](/docs/api/contents)
        ...
        - [Datenschnittstelle für externe Verknüpfungen](/docs/api/contents/external_connections)
        - [Datenschnittstelle für Duplikatskandidaten](/docs/api/contents/duplicates)
    ...
    - [Individuelle Bild-URLs (imgproxy)](/docs/api/image_urls)
- [Authentifizierung über OAuth 2.0 / OpenID Connect](/docs/oauth)
