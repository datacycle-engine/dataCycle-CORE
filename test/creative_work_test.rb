...
module DataCycleCore
  class CreativeWorkTest < ActiveSupport::TestCase
    ...
    test 'save CreativeWork with two embedded objects each for every translation (full access to embeddedObjects)' do
      ...
      puts "Deutsch:"
      ap I18n.with_locale(:de) { data_set.get_data_hash }
      puts "Englisch:"
      ap I18n.with_locale(:en) { data_set.get_data_hash }
    ...
    #   assert_equal(expected_hash, received_hash.except('id', 'data_pool', 'permitted_creator', 'creator'))
