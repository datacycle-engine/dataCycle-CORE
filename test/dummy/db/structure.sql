...
CREATE UNIQUE INDEX index_classification_contents_on_unique_constraint ON classification_contents USING btree (content_data_id, classification_id, relation);
...
CREATE INDEX index_stored_filters_on_updated_at ON stored_filters USING btree (updated_at);
...
CREATE INDEX index_things_on_boost_updated_at ON things USING btree (boost, updated_at);
