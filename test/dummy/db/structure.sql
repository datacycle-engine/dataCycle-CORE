...
WHERE table_name = 'classification_contents'
    AND column_name NOT IN ('id', 'content_data_id');
...
FROM information_schema.columns
WHERE table_name = 'content_contents'
    AND column_name NOT IN ('id', 'content_a_id', 'content_b_id');
...
WHERE table_name = 'schedules'
    AND column_name NOT IN ('id', 'thing_id');
...
FROM information_schema.columns
WHERE table_name = 'thing_translations'
    AND column_name NOT IN ('id', 'thing_id');
