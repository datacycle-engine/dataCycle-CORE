...
ALTER TABLE ONLY public.collected_classification_contents
    ADD CONSTRAINT collected_classification_contents_pkey PRIMARY KEY (thing_id, classification_alias_id);
