...
--
-- Name: geom_vao_export_update(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.geom_vao_export_update() RETURNS TRIGGER LANGUAGE plpgsql AS $$ BEGIN NEW.geom_vao_export := (
    SELECT ST_GeomFromText(
            ST_AsText(
                ST_Force2D(COALESCE(things."location", things.line)),
                6
            ),
            4326
        )
...
CREATE TABLE public.things (
    ...
    geom_vao_export public.geometry(Geometry, 4326)
);
...
--
-- Name: index_cc_histories_on_unique_constraint; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_cc_histories_on_unique_constraint ON public.classification_content_histories USING btree (
...
--
-- Name: index_things_on_geom_vao_export_spatial; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_things_on_geom_vao_export_spatial ON public.things USING gist (geom_vao_export);
...
--
-- Name: things geom_vao_export_insert_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER geom_vao_export_insert_trigger BEFORE
INSERT ON public.things FOR EACH ROW EXECUTE FUNCTION public.geom_vao_export_update();

--
-- Name: things geom_vao_export_update_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER geom_vao_export_update_trigger BEFORE
UPDATE OF location,
    line ON public.things FOR EACH ROW
    WHEN (
        (
    ...
    ) EXECUTE FUNCTION public.geom_vao_export_update();
