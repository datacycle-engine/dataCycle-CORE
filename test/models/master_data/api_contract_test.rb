...
module DataCycleCore
  class ApiContractTest < DataCycleCore::TestCases::ActiveSupportTestCase
    ...
    test 'filter[classifications][in][withSubtree][] returns error for invalid params' do
      ...
      assert_equal 'must be a valid UUIDv4 or a list of UUIDv4s separated by commas', validation.errors.to_a.first.to_s
      ...
      assert_equal 'is in invalid format', validation.errors.to_a.first.to_s
      ...
      assert_equal 'is in invalid format', validation.errors.to_a.last.to_s
    end
