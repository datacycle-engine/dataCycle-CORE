...
module DataCycleCore
  class ConceptMoveAfterTest < DataCycleCore::TestCases::ActiveSupportTestCase
    before(:all) do
      @tree_label1 = DataCycleCore::ConceptScheme.create!(name: 'CLASSIFICATION TREE 1')
      @tree_label2 = DataCycleCore::ConceptScheme.create!(name: 'CLASSIFICATION TREE 2')

      [@tree_label1, @tree_label2].each.with_index do |tree_label, index|
        instance_variable_set(:"@alias#{index}0", tree_label.create_concept('A'))
        instance_variable_set(:"@alias#{index}1", tree_label.create_concept('A', '1'))
        instance_variable_set(:"@alias#{index}2", tree_label.create_concept('A', '2'))
        instance_variable_set(:"@alias#{index}3", tree_label.create_concept('A', '3'))
        instance_variable_set(:"@alias#{index}4", tree_label.create_concept('A', '3', '11'))
        instance_variable_set(:"@alias#{index}5", tree_label.create_concept('A', '3', '22'))
        instance_variable_set(:"@alias#{index}6", tree_label.create_concept('A', '3', '33'))

        instance_variable_set(:"@alias#{index}7", tree_label.create_concept('B'))
        instance_variable_set(:"@alias#{index}8", tree_label.create_concept('B', '1'))
        instance_variable_set(:"@alias#{index}9", tree_label.create_concept('B', '2'))
        instance_variable_set(:"@alias#{index}10", tree_label.create_concept('B', '3'))
        instance_variable_set(:"@alias#{index}11", tree_label.create_concept('B', '3', '11'))
        instance_variable_set(:"@alias#{index}12", tree_label.create_concept('B', '3', '22'))
        instance_variable_set(:"@alias#{index}13", tree_label.create_concept('B', '3', '33'))
      end
    end
    ...
    test 'order_a is set after update' do
      @alias01.parent_concept_link.update(parent_id: nil)

      assert_not_nil @alias01.reload.order_a
    end

    test 'move_after on single level without parent' do
    ...
    test 'move_after on single level with parent' do
