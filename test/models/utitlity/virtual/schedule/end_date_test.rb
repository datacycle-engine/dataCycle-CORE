...
describe 'DataCycleCore::Utility::Virtual::Schedule#end_date' do
  ...
  it 'should return correct end_date for schedule' do
    ...
    end_date = subject.end_date(virtual_parameters: ['event_schedule'], virtual_definition: { 'type' => 'datetime', 'virtual' => { 'parameters' => ['event_schedule'] } }, content:)

    assert_equal(dtend, end_date)
  end
end
