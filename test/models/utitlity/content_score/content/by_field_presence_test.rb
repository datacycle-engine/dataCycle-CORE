      ...
      module Content
        class ByFieldPresence < DataCycleCore::TestCases::ActiveSupportTestCase
          ...
          test 'by_field_presence works with score_matrix and presence' do
            ...
            assert_in_delta(0.4, @content.calculate_content_score(nil, { 'height' => 0 }))
            assert_in_delta(0.4, @content.calculate_content_score(nil, { 'height' => 100 }))
            assert_in_delta(0.4, @content.calculate_content_score(nil, { 'height' => 100, 'width' => nil }))
