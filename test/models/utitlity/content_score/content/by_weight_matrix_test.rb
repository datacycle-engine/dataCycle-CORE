      ...
      module Content
        class ByWeightMatrix < DataCycleCore::TestCases::ActiveSupportTestCase
          ...
          test 'by_weight_matrix works with normal matrix and presence' do
            ...
            assert_in_delta(0.5, @content.calculate_content_score(nil, { 'width' => 0 }))
            assert_in_delta(0.5, @content.calculate_content_score(nil, { 'height' => 0 }))
            assert_in_delta(0.5, @content.calculate_content_score(nil, { 'height' => 100 }))
            assert_in_delta(0.5, @content.calculate_content_score(nil, { 'height' => 100, 'width' => nil }))
