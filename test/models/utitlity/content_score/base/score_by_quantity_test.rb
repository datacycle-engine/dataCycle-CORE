      ...
      module Base
        class ScoreByQuantity < DataCycleCore::TestCases::ActiveSupportTestCase
          ...
          test 'score_by_quantity works with min and optimal' do
            ...
            assert_equal 0, DataCycleCore::Utility::ContentScore::Base.score_by_quantity(0, config)
            assert_in_delta(0.01, DataCycleCore::Utility::ContentScore::Base.score_by_quantity(1, config))
            assert_equal 1, DataCycleCore::Utility::ContentScore::Base.score_by_quantity(2.0, config)
          ...
          test 'score_by_quantity works with min, optimal and max' do
            ...
            assert_in_delta(0.01, DataCycleCore::Utility::ContentScore::Base.score_by_quantity(1, config))
            assert_equal 1, DataCycleCore::Utility::ContentScore::Base.score_by_quantity(2.0, config)
            assert_in_delta(0.01, DataCycleCore::Utility::ContentScore::Base.score_by_quantity(3, config))
          ...
          test 'score_by_quantity works with float numbers' do
            ...
            assert_equal 0, DataCycleCore::Utility::ContentScore::Base.score_by_quantity(0, config)
            assert_in_delta(0.01, DataCycleCore::Utility::ContentScore::Base.score_by_quantity(1, config))
            assert_in_delta(0.01, DataCycleCore::Utility::ContentScore::Base.score_by_quantity(2.0, config))
          ...
          test 'score_by_quantity works with large values' do
            ...
            assert_in_delta(0.01, DataCycleCore::Utility::ContentScore::Base.score_by_quantity(1000, config))
            assert_in_delta(0.505, DataCycleCore::Utility::ContentScore::Base.score_by_quantity(1250, config))
            assert_equal 1, DataCycleCore::Utility::ContentScore::Base.score_by_quantity(1500, config)
            assert_in_delta(0.01, DataCycleCore::Utility::ContentScore::Base.score_by_quantity(2000, config))
