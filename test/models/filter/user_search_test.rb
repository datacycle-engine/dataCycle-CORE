...
module DataCycleCore
  class UserSearchTest < DataCycleCore::TestCases::ActiveSupportTestCase
    before(:all) do
      ...
      content1 = create_content('Artikel', { name: 'HEADLINE 1' }, @creator)
      update_content(content1, { name: 'HEADLINE 11' }, @editor1)
      update_content(content1, { name: 'HEADLINE 12' }, @editor2)
      content2 = create_content('Artikel', { name: 'HEADLINE 2' }, @creator)
      update_content(content2, { name: 'HEADLINE 21' }, @editor1)
      create_content('Artikel', { name: 'HEADLINE 3' }, @creator)
    end
