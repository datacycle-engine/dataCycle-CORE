...
module DataCycleCore
  class SearchTest < DataCycleCore::TestCases::ActiveSupportTestCase
    before(:all) do
      ...
      multiling.external_source_id = DataCycleCore::ExternalSystem.find_by(identifier: 'outdooractive').id
    ...
    test 'test query for external_source' do
      external_source_id = DataCycleCore::ExternalSystem.find_by(identifier: 'outdooractive').id
