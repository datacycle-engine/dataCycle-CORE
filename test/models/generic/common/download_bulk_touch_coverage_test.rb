...
module DataCycleCore
  module Generic
    module Common
      # Coverage for DownloadBulkTouch.data_id (pure) and the stubbed delegation.
      class DownloadBulkTouchCoverageTest < DataCycleCore::TestCases::ActiveSupportTestCase
        def subject
          DataCycleCore::Generic::Common::DownloadBulkTouch
        end
        ...
        test 'download_content delegates to DownloadFunctions.bulk_touch_items' do
          DataCycleCore::Generic::Common::DownloadFunctions.stub(:bulk_touch_items, nil) do
