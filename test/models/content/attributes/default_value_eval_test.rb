...
module DataCycleCore
  module Content
    module Attributes
      class DefaultValueEvalTest < ActiveSupport::TestCase
        test 'set data property (stored as root value) with eval-default_value' do
          data_set = DataCycleCore::TestPreparations.data_set_object('Bild')
          data_set.schema['properties']['upload_date']['default_value'] = '{{ Time.zone.now.beginning_of_day }}'
          data_set.save
        ...
        test 'set data property (stored as root value) with eval-default_value, set value remains unchanged' do
          data_set = DataCycleCore::TestPreparations.data_set_object('Bild')
          data_set.schema['properties']['upload_date']['default_value'] = '{{ Time.zone.now.beginning_of_day }}'
          data_set.save
        ...
        test 'set data property (stored as root translated_value) with eval-default_value, set value remains unchanged' do
          data_set = DataCycleCore::TestPreparations.data_set_object('Bild')
          data_set.schema['properties']['upload_date']['storage_location'] = 'translated_value'
          data_set.schema['properties']['upload_date']['default_value'] = '{{ Time.zone.now.beginning_of_day }}'
          data_set.save
        ...
        test 'set data property (stored as object in value) with eval-default_value' do
          data_set = DataCycleCore::TestPreparations.data_set_object('Artikel')
          data_set.schema['properties']['validity_period']['properties']['valid_from']['default_value'] = '{{ Time.zone.now.beginning_of_day }}'
          data_set.save
        ...
        test 'set data property (stored as object in value) with eval-default_value, set value remains unchanged' do
          data_set = DataCycleCore::TestPreparations.data_set_object('Artikel')
          data_set.schema['properties']['validity_period']['properties']['valid_from']['default_value'] = '{{ Time.zone.now.beginning_of_day }}'
          data_set.save
        ...
        test 'set data property (stored as object in translated_value) with eval-default_value' do
          data_set = DataCycleCore::TestPreparations.data_set_object('Artikel')
          data_set.schema['properties']['validity_period']['properties']['valid_from']['default_value'] = '{{ Time.zone.now.beginning_of_day }}'
        ...
        test 'set data property (stored as object in translated_value) with eval-default_value, set value remains unchanged' do
          data_set = DataCycleCore::TestPreparations.data_set_object('Artikel')
          data_set.schema['properties']['validity_period']['properties']['valid_from']['default_value'] = '{{ Time.zone.now.beginning_of_day }}'
          data_set.schema['properties']['validity_period']['storage_location'] = 'translated_value'
          data_set.schema['properties']['validity_period']['properties']['valid_from']['storage_location'] = 'translated_value'
        ...
        test 'set data property (stored in column) with eval-default_value' do
          data_set = DataCycleCore::TestPreparations.data_set_object('Bild')
        ...
        test 'set data property (stored in column) with eval-default_value, set value remains the same' do
          data_set = DataCycleCore::TestPreparations.data_set_object('Bild')
          data_set.schema['properties']['description']['default_value'] = '{{ Time.zone.now.beginning_of_day.to_s }}'
          data_set.save
