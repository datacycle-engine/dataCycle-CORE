          ...
          module Persons
            class Person < DataCycleCore::TestCases::ActionDispatchIntegrationTest
              ...
              test 'xml of stored person exists and is correct' do
                ...
                assert_equal('Person', xml_data.dig('type'))
                assert_equal('Person', xml_data.dig('contentType'))
                ...
                # content data
                assert_equal(@content.given_name, xml_data.dig('givenName'))
                assert_equal(@content.family_name, xml_data.dig('familyName'))
                assert_equal(@content.honorific_prefix, xml_data.dig('honorificPrefix'))
                assert_equal(@content.honorific_suffix, xml_data.dig('honorificSuffix'))
                assert_equal(@content.job_title, xml_data.dig('jobTitle'))
