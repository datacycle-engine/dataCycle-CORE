      ...
      module Content
        module Extensions
          module CreativeWorks
            class Pdf < DataCycleCore::TestCases::ActionDispatchIntegrationTest
              before(:all) do
                DataCycleCore::Thing.where(template: false).delete_all
                @content = DataCycleCore::DummyDataHelper.create_data('pdf')
              end
              ...
              test 'json of stored image exists and is correct' do
                ...
                assert_equal('MediaObject', json_data.dig('@type').last)
