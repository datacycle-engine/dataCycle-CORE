      ...
      module Content
        module Extensions
          module CreativeWorks
            class Image < ActionDispatch::IntegrationTest
              ...
              setup do
                ...
                creative_work_data_hash = DataCycleCore::TestPreparations.load_dummy_data_hash('creative_works', 'api_image')
                @content = DataCycleCore::TestPreparations.create_content(template_name: 'Bild', data_hash: creative_work_data_hash)
