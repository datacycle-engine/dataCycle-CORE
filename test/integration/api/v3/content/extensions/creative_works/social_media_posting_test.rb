      ...
      module Content
        module Extensions
          module CreativeWorks
            class SocialMediaPosting < ActionDispatch::IntegrationTest
              ...
              setup do
                ...
                @content = DataCycleCore::TestPreparations.create_content(template_name: 'SocialMediaPosting', data_hash: creative_work_data_hash)
              ...
              test 'json of stored article exists' do
                ...
                assert_equal('Social Media Posting', classification_hash.dig('name'))
              ...
              test 'stored item can be found via different endpoints' do
                ...
                assert_response(:success)
                assert_equal('application/json', response.content_type)
                json_data = JSON.parse(response.body).dig('data').select { |item| item.dig('contentType') == 'SocialMediaPosting' }.first
                assert_equal(@content.id, json_data.dig('identifier'))
