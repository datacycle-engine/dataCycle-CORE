      ...
      module Content
        module Extensions
          module CreativeWorks
            class Pdf < ActionDispatch::IntegrationTest
              ...
              setup do
                ...
                creative_work_data_hash = DataCycleCore::TestPreparations.load_dummy_data_hash('creative_works', 'api_pdf')
                @content = DataCycleCore::TestPreparations.create_content(template_name: 'PDF', data_hash: creative_work_data_hash)
              ...
              test 'json of stored image exists and is correct' do
                ...
                assert_equal('PDF', json_data.dig('contentType'))
                ...
                assert_equal('PDF', classification_hash.dig('name'))
