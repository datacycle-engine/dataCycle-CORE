      ...
      module Content
        module Extensions
          module CreativeWorks
            class Asset < ActionDispatch::IntegrationTest
              ...
              setup do
                ...
                creative_work_data_hash = DataCycleCore::TestPreparations.load_dummy_data_hash('creative_works', 'api_asset')
                @content = DataCycleCore::TestPreparations.create_content(template_name: 'Datei', data_hash: creative_work_data_hash)
              ...
              test 'json of stored image exists and is correct' do
                ...
                assert_equal('MediaObject', json_data.dig('@type'))
                assert_equal('Datei', json_data.dig('contentType'))
                ...
                assert_equal('Datei', classification_hash.dig('name'))
