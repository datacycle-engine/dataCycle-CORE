      ...
      module Content
        module Extensions
          module CreativeWorks
            class Interview < ActionDispatch::IntegrationTest
              ...
              setup do
                ...
                @content = DataCycleCore::TestPreparations.create_content(template_name: 'Interview', data_hash: creative_work_data_hash)
              ...
              test 'json of stored article exists' do
                ...
                assert_equal('Interview', json_data.dig('contentType'))
                ...
                assert_equal('Interview', classification_hash.dig('name'))
              ...
              test 'stored item can be found via different endpoints' do
                ...
                assert_response(:success)
                assert_equal('application/json', response.content_type)
                json_data = JSON.parse(response.body).dig('data').select { |item| item.dig('contentType') == 'Interview' }.first
                assert_equal(@content.id, json_data.dig('identifier'))
