      ...
      module Content
        module Extensions
          module CreativeWorks
            class Audio < ActionDispatch::IntegrationTest
              ...
              setup do
                ...
                creative_work_data_hash = DataCycleCore::TestPreparations.load_dummy_data_hash('creative_works', 'api_audio')
                @content = DataCycleCore::TestPreparations.create_content(template_name: 'Audio', data_hash: creative_work_data_hash)
              ...
              test 'json of stored image exists and is correct' do
                ...
                assert_equal('AudioObject', json_data.dig('@type'))
