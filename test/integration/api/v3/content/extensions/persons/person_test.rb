          ...
          module Persons
            class Person < DataCycleCore::TestCases::ActionDispatchIntegrationTest
              ...
              test 'json of stored person exists and is correct' do
                ...
                assert_equal('Person', json_data['@type'])
                assert_equal('Person', json_data['contentType'])
                ...
                # content data
                assert_equal(@content.given_name, json_data['givenName'])
                assert_equal(@content.family_name, json_data['familyName'])
                assert_equal(@content.honorific_prefix, json_data['honorificPrefix'])
                assert_equal(@content.honorific_suffix, json_data['honorificSuffix'])
                assert_equal(@content.job_title, json_data['jobTitle'])
