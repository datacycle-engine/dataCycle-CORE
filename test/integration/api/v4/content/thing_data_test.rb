        ...
        class ThingDataTest < DataCycleCore::V4::Base
          ...
          test 'api_v4_thing_path validate full event with all linked/embedded/scheduled data' do
            ...
            event_schedule_api_values = {
              ...
              'inLanguage' => 'de',
              'startDate' => event_schedule_object_hash.dig(:dtstart).to_formatted_s(:only_date),
              'startTime' => event_schedule_object_hash.dig(:dtstart).to_formatted_s(:only_time),
              'endDate' => (event_schedule_object_hash.dig(:dtstart) + event_schedule_object.duration).to_formatted_s(:only_date),
              'endTime' => (event_schedule_object_hash.dig(:dtstart) + event_schedule_object.duration).to_formatted_s(:only_time),
