...
module DataCycleCore
  module Api
    module V4
      module General
        module Links
          class EndpointsTest < DataCycleCore::TestCases::ActionDispatchIntegrationTest
            ...
            before(:all) do
              ...
              @stored_filter = DataCycleCore::StoredFilter.create(name: 'Test Filter', user: @user, api: true)
              @test_route = method(:api_v4_stored_filter_path)
